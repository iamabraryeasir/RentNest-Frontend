...
export function LogoIcon({ className, iconSize = 32, ...props }: React.SVGProps<SVGSVGElement> & { iconSize?: number }) {
  return (
    <svg
      width={iconSize}
      height={iconSize}
...
export function Logo({ className, iconSize = 32, showText = true, ...props }: LogoProps) {
  return (
    <div className={cn("flex items-center gap-2 font-semibold select-none", className)}>
